...
export default function AdminChatPage() {
        ...
        <>
              ...
              messages.map((msg) => {
                ...
                return (
                  <div key={msg._id} className={`flex ${isAdmin ? "justify-end" : "justify-start"}`}>
                    ...
                    <div className={`max-w-[75%] px-4 py-2.5 rounded-2xl text-sm shadow-sm mx-2 ${isAdmin ? "bg-red-600 text-white rounded-br-sm" : "bg-white text-gray-800 border border-gray-200 rounded-bl-sm"}`}>
          ...
          <div className="bg-white border-t border-gray-200 px-4 py-3 flex items-center gap-3">
            <input
              ...
              className="flex-1 px-4 py-2.5 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-red-500 text-gray-900 placeholder-gray-400 text-sm bg-gray-50"
            />
            <button
              onClick={sendMessage}
  ...
  return (
    <div className="h-[calc(100vh-120px)] rounded-2xl overflow-hidden shadow border border-gray-200">
