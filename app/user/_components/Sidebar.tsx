...
export default function Sidebar() {
  ...
  const navItems = [
    { href: "/user/dashboard", label: "Dashboard", icon: <HiChartBar size={22} /> },
    { href: "/user/adopt", label: "Adopt", icon: <HiHeart size={22} /> },
    { href: "/user/post", label: "Post", icon: <HiPencil size={22} /> },
    { href: "/user/chat", label: "Chat", icon: <HiChat size={22} /> },
    { href: "/user/profile", label: "Profile", icon: <HiUser size={22} /> },
    ...(user?.role === "admin"
      ? [{ href: "/admin/users", label: "Admin Panel", icon: <HiCog size={22} /> }]
      : []),
  ];
